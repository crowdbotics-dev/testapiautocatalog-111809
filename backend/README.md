...
## Project Structure
    ...
    ├── testapiautocatalog_111809  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111809`
...
2. Clone this repo and `cd testapiautocatalog_111809`
